...
const Loading = ({ onComplete }) => {
  ...
  useEffect(() => {
    ...
    function drawCloth() {
      ...
      // Draw each quad with Neon Nebula colors
      for (let i = 0; i < cols - 1; i++) {
        for (let j = 0; j < rows - 1; j++) {
          ...
          // Beautiful gradient with AI-era colors
          const gradient = ctx.createLinearGradient(p0.x, p0.y, p2.x, p2.y);
          gradient.addColorStop(0, 'rgba(0, 240, 255, 0.15)');   // Cyan
          gradient.addColorStop(0.3, 'rgba(139, 92, 246, 0.25)'); // Purple
          gradient.addColorStop(0.7, 'rgba(236, 72, 153, 0.2)');  // Pink
          gradient.addColorStop(1, 'rgba(0, 240, 255, 0.1)');     // Cyan
  ...
  return (
    ...
    >
      ...
      {/* Futuristic rope - top right anchored with Neon Nebula colors */}
      <div className="absolute right-8 top-8 z-20">
        ...
        >
          ...
          {/* Rope - with Neon Nebula gradient */}
          <div 
      ...
      {/* Minimal instruction with cyber glow */}
